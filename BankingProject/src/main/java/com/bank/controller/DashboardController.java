...
public class DashboardController {
	...
	@RequestMapping(path="/dashboardaccSummary.jsp", method = RequestMethod.POST)
	...
	@RequestMapping(path="/dashboardfundTransfer.jsp", method = RequestMethod.POST)
	...
	@RequestMapping(path="/dashboardaccStatement.jsp", method = RequestMethod.POST)
